...
def detectPlatesInScene(imgOriginalScene):
    listOfPossiblePlates1 = []
    listOfPossiblePlates2 = []
    ...
    imgGrayscaleScene, imgThreshScene, imgThreshScene2 = Preprocess.preprocess(imgOriginalScene)         # preprocess to get grayscale and threshold images
    
    listOfPossiblePlates1 = helperFunc(imgOriginalScene,imgThreshScene)
    listOfPossiblePlates2 = helperFunc(imgOriginalScene,imgThreshScene2)   

    return listOfPossiblePlates1,listOfPossiblePlates2
